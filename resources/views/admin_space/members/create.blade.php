...
@section('page_title', 'INSCRIPTION MEMBRE')
...
<div class="container-fluid py-4 px-lg-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            <h1 class="fw-900 text-white mb-1 uppercase letter-spacing">NOUVELLE <span style="color: var(--accent);">INSCRIPTION</span></h1>
            <p class="text-secondary small uppercase letter-spacing-xs">INITIALISATION D'UN NOUVEL ACCÈS AU SYSTÈME</p>
        </div>
            ...
            <div class="edit-terminal">
                ...
                <div class="terminal-top-bar">
                    ...
                    <div class="protocol-status">
                        <span class="status-dot"></span> ENREGISTREMENT_MEMBRE: INITIALISATION
                    </div>
                    <div class="sys-id letter-spacing-xs"></div>
                </div>

                <!-- Profil Identity Bar -->
                <div class="coach-identity-bar">
                    <div class="avatar-hex">
                        <i class="fas fa-user-plus text-white" style="z-index: 2; font-size: 1.5rem;"></i>
                        <svg class="hex-svg" viewBox="0 0 100 100"><polygon points="50 1, 95 25, 95 75, 50 99, 5 75, 5 25" /></svg>
                    </div>
                    <div class="ms-4">
                        <h5 class="m-0 fw-900 text-white uppercase letter-spacing-sm">NOUVEL ADHÉRENT</h5>
                        <span class="text-secondary uppercase letter-spacing-sm" style="font-size: 9px;">
                ...
                <div class="p-4 p-lg-5">
                    <form action="{{ route('admin.members.store') }}" method="POST">
                        ...
                        <div class="row g-4">
                            ...
                            <!-- Nom Complet -->
                            <div class="col-md-12">
                                <label class="tiny-caps">IDENTITÉ COMPLÈTE DE L'ADHÉRENT</label>
                                <div class="neo-input-group mt-2">
                                    <i class="fas fa-user-ninja"></i>
                                    <input type="text" name="name" required placeholder="NOM ET PRÉNOM..." class="uppercase">
                                </div>
                            </div>

                            <!-- Email -->
                            <div class="col-md-6">
                                <label class="tiny-caps">ADRESSE E-MAIL DE CONTACT</label>
                                <div class="neo-input-group mt-2">
                                    <i class="fas fa-envelope"></i>
                                    <input type="email" name="email" required placeholder="EMAIL@CLIENT.COM" class="uppercase">
                                </div>
                            </div>

                            <!-- رقم الهاتف (الحقل الجديد) -->
                            <div class="col-md-6">
                                <label class="tiny-caps">NUMÉRO DE TÉLÉPHONE</label>
                                <div class="neo-input-group mt-2">
                                    <i class="fas fa-phone-alt"></i>
                                    <input type="text" name="phone" placeholder="06 00 00 00 00" class="uppercase">
                                </div>
                            </div>

                            <!-- Pack/Abonnement -->
                            <div class="col-md-12">
                                <label class="tiny-caps">TYPE D'ABONNEMENT (PACK)</label>
                                <div class="neo-input-group mt-2">
                                    <i class="fas fa-crown"></i>
                                    <select name="abonnement_id" required class="uppercase">
                                        <option value="" disabled selected style="background: #111;">SÉLECTIONNER UN PACK</option>
                                        @foreach($types as $type)
                                            <option value="{{ $type->id }}" style="background: #111; color: #fff;">
                            ...
                            <div class="col-12 mt-4">
                                <button type="submit" class="btn-submit">
                                    <i class="fas fa-shield-alt me-2"></i> CONFIRMER L'INSCRIPTION SYSTÈME
                                </button>
                            </div>
...
<style>
    ...
    .brand-logo { font-size: 1.4rem; letter-spacing: 4px; font-weight: 900; color: #fff; }
    ...
    .neo-input-group i { color: var(--accent); margin-right: 15px; font-size: 13px; }
    ...
    .btn-submit {
        ...
        padding: 18px; border-radius: 12px; font-weight: 900; font-size: 14px;
    ...
    .elite-btn-back { text-decoration: none; color: rgba(255,255,255,0.4); font-size: 11px; font-weight: 900; letter-spacing: 2px; text-transform: uppercase; transition: 0.3s; }
